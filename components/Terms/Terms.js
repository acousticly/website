    ...
    <section className="section-terms">
      ...
      <div className="section-terms__content">
        ...
        <p>
          ...
          for some other reason. <br /> Whenever we make changes to these Terms,
          the changes are effective 24-hours after we post such revised Terms
          (indicated by revising the date at the top of these Terms) or upon
          your acceptance if we provide a mechanism for your immediate
          acceptance of the revised Terms (such as a click-through confirmation
          or acceptance button). It is your responsibility to check Acoustic for
          changes to these Terms. <br /> If you continue to use the Service
          after the revised Terms go into effect, then you have accepted the
          ...
          laws. We grant you the right to use it. <br /> However, unless we
          expressly state otherwise, your rights do not include: (i) publicly
          performing or publicly displaying the Service; (ii) modifying or
          otherwise making any derivative uses of the Service or any portion
          thereof; (iii) using any data mining, robots or similar data gathering
          or extraction methods; (iv) downloading (other than page caching) of
          any portion of the Service or any information contained therein; (v)
          reverse engineering or accessing the Service in order to build a
          competitive product or service; or (vi) using the Service other than
          for its intended purposes. If you do any of this stuff, we may
        ...
        <p>
          ...
          <br /> Acoustic makes no claim or representation regarding, and
        ...
        <p>
          ...
          <br />
          IN NO EVENT WILL Acoustic BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY
          ...
          AMOUNT YOU PAID TO Acoustic. THIS SECTION WILL BE GIVEN FULL EFFECT
          EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE
          FAILED OF ITS ESSENTIAL PURPOSE.
          <br /> You agree to defend, indemnify and hold us harmless from and
        ...
        <p>
          ...
          the State Of California and you further agree and expressly consent to
          the exercise of personal jurisdiction in the courts of the State Of
          California located in the greater Silicon Valley area in connection
          with any such dispute including any claim involving Service. You
          further agree that you and Service will not commence against the other
        ...
        <p>
          These Terms constitute the entire agreement between you and Acoustic
          regarding the use of the Service, superseding any prior agreements
          between you and Acoustic relating to your use of the Service.
        </p>
        <h2>Feedback</h2>
        <p>
          Please let us know what you think of the Service, these Terms and, in
          general, Acoustic. When you provide us with any feedback, comments or
          suggestions about the Service, these Terms and, in general, Acoustic,
