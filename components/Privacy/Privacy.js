...
const Privacy = () => {
  return (
    <section className="section-privacy">
      <h1 className="section-privacy__title">Privacy Policy</h1>
      <p>Last Updated: 11/10/21</p>
      <div className="section-privacy__content">
        <h2>Preamble</h2>
        <p>
          At Acoustic, accessible from https://acoustic.to, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Acoustic and how we use it. If you have additional questions or
          ...
          information that they shared and/or collect in Acoustic. This policy
          is not applicable to any information collected offline or via channels
          other than this website.
        </p>
        <h2>Consent</h2>
        <p>
          By using our website & any of our products, you hereby consent to our
        ...
        <p>
          ...
          We intend to collect some anonymous information for a variety of
          ...
          <br />
          ● Understand and analyze how you use our website● Develop new
          ...
          <br />
          <h2>Log Files</h2>
          Acoustic follows a standard procedure of using log files. These files
          ...
          Like any other website, Acoustic uses &apos;cookies&apos;. These
        ...
        <p>
          Acoustic&apos;s Privacy Policy does not apply to other advertisers or
          ...
          <br /> The right to access &ndash; You have the right to request
          ...
          would like to exercise any of these rights, please contact us.
          <br />
          <h2>Children&apos;s Information (COPPA)</h2>
          Another part of our priority is adding protection for children while
          using the internet. We encourage parents and guardians to observe,
          participate in, and/or monitor and guide their online activity.
          <br />
          Acoustic does not knowingly collect any Personal Identifiable
          Information from children under the age of 13. If you think that your
          child provided this kind of information on our website, we strongly
          encourage you to contact us immediately and we will do our best
          efforts to promptly remove such information from our records. <br />
          <br />
        </p>
      </div>
    </section>
